...
/obj/structure/closet/freezer/Destroy()
	toggle_organ_decay(src)
	return ..()

/obj/structure/closet/freezer/Initialize(mapload)
	. = ..()
	toggle_organ_decay(src)

/obj/structure/closet/freezer/open(mob/living/user, force = FALSE)
	if(opened || !can_open(user, force)) //dupe check just so we don't let the organs decay when someone fails to open the locker
		return FALSE
	toggle_organ_decay(src)
	return ..()

/obj/structure/closet/freezer/close(mob/living/user)
...
/obj/structure/closet/freezer/empty
	name = "empty freezer"

/obj/structure/closet/freezer/empty/open
	req_access = null
	locked = FALSE
...
/obj/structure/closet/freezer/kitchen/PopulateContents()
	..()
	for(var/i in 1 to 3)
...
/obj/structure/closet/freezer/kitchen/maintenance
	name = "maintenance refrigerator"
	desc = "This refrigerator looks quite dusty, is there anything edible still inside?"
	req_access = list()

/obj/structure/closet/freezer/kitchen/maintenance/PopulateContents()
	..()
	for(var/i in 1 to 5)
...
/obj/structure/closet/freezer/kitchen/mining
	req_access = list()
...
/obj/structure/closet/freezer/meat/open
	req_access = list()
	locked = FALSE

/obj/structure/closet/freezer/gulag_fridge
	name = "refrigerator"

/obj/structure/closet/freezer/gulag_fridge/PopulateContents()
	..()
	for(var/i in 1 to 3)
...
/obj/structure/closet/freezer/fridge/PopulateContents()
	..()
	for(var/i in 1 to 5)
		new /obj/item/reagent_containers/condiment/milk(src)
		new /obj/item/reagent_containers/condiment/soymilk(src)
...
/obj/structure/closet/freezer/fridge/open
	req_access = null
	locked = FALSE

/obj/structure/closet/freezer/money
	name = "freezer"
	desc = "This contains cold hard cash."
	req_access = list(ACCESS_VAULT)

/obj/structure/closet/freezer/money/PopulateContents()
	..()
	for(var/i in 1 to 3)
...
/obj/structure/closet/freezer/cream_pie
	name = "cream pie closet"
	desc = "Contains pies filled with cream and/or custard, you sickos."
	req_access = list(ACCESS_THEATRE)

/obj/structure/closet/freezer/cream_pie/PopulateContents()
	..()
